...
<img src="/_media/flyfish-viewer-demo-zh.gif" alt="Flyfish Viewer 中文 Demo 动图，展示 Office、多格式文件与工具栏预览" />
<figcaption>中文浏览器 Demo 展示 Office、多格式文件预览与常用工具栏操作。</figcaption>
</figure>
