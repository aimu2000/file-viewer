...
These projects are intentionally small, self-contained starting points built against the public `2.1.27` packages. Each one has a local sample, a file picker, production asset copying, and a real build command.
